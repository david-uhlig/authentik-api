  ...
  class SCIMSource < ApiModelBase
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Authentik::Api::SCIMSource` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Authentik::Api::SCIMSource`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @root_url.nil?
        invalid_properties.push('invalid value for "root_url", root_url cannot be nil.')
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] root_url Value to be assigned
    def root_url=(root_url)
      if root_url.nil?
        fail ArgumentError, 'root_url cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] token_obj Value to be assigned
    def token_obj=(token_obj)
      if token_obj.nil?
        fail ArgumentError, 'token_obj cannot be nil'
      end
    ...
    def hash
      [pk, name, slug, enabled, user_property_mappings, group_property_mappings, component, verbose_name, verbose_name_plural, meta_model_name, managed, user_path_template, root_url, token_obj].hash
    end
