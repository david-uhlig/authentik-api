...
module Authentik::Api
  ...
  class RACPropertyMapping < ApiModelBase
    attr_accessor :pk
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Authentik::Api::RACPropertyMapping` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Authentik::Api::RACPropertyMapping`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'static_settings')
        if (value = attributes[:'static_settings']).is_a?(Hash)
          self.static_settings = value
        end
      else
        self.static_settings = nil
      end
    end
    ...
    def list_invalid_properties
      ...
      if @static_settings.nil?
        invalid_properties.push('invalid value for "static_settings", static_settings cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @static_settings.nil?
      true
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] static_settings Value to be assigned
    def static_settings=(static_settings)
      if static_settings.nil?
        fail ArgumentError, 'static_settings cannot be nil'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          static_settings == o.static_settings
    end
    ...
    def hash
      [pk, managed, name, expression, component, verbose_name, verbose_name_plural, meta_model_name, static_settings].hash
    end
