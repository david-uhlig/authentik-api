...
module Authentik::Api
  ...
  class FlowStageBinding < ApiModelBase
    attr_accessor :pk
    ...
    # Custom attribute writer method with validation
    # @param [Object] stage_obj Value to be assigned
    def stage_obj=(stage_obj)
      if stage_obj.nil?
        fail ArgumentError, 'stage_obj cannot be nil'
      end
