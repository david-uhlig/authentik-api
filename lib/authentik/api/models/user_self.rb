...
module Authentik::Api
  ...
  class UserSelf < ApiModelBase
    ...
    attr_accessor :system_permissions
    ...
    # Custom attribute writer method with validation
    # @param [Object] system_permissions Value to be assigned
    def system_permissions=(system_permissions)
      if system_permissions.nil?
        fail ArgumentError, 'system_permissions cannot be nil'
      end
