...
module Authentik::Api
  class FlowsApi
    ...
    # @option opts [Boolean] :clear  (default to false)
    # @return [nil]
    def flows_instances_set_background_create(slug, opts = {})
      flows_instances_set_background_create_with_http_info(slug, opts)
      nil
    end
    ...
    # @option opts [Boolean] :clear  (default to false)
    # @return [Array<(nil, Integer, Hash)>] nil, response status code and response headers
    def flows_instances_set_background_create_with_http_info(slug, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: FlowsApi.flows_instances_set_background_create ...'
      end
      # verify the required parameter 'slug' is set
      if @api_client.config.client_side_validation && slug.nil?
        fail ArgumentError, "Missing the required parameter 'slug' when calling FlowsApi.flows_instances_set_background_create"
      end
      # resource path
      local_var_path = '/flows/instances/{slug}/set_background/'.sub('{' + 'slug' + '}', CGI.escape(slug.to_s))
      ...
      new_options = opts.merge(
        :operation => :"FlowsApi.flows_instances_set_background_create",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: FlowsApi#flows_instances_set_background_create\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def flows_instances_set_background_url_create(slug, file_path_request, opts = {})
      flows_instances_set_background_url_create_with_http_info(slug, file_path_request, opts)
      nil
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(nil, Integer, Hash)>] nil, response status code and response headers
    def flows_instances_set_background_url_create_with_http_info(slug, file_path_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: FlowsApi.flows_instances_set_background_url_create ...'
      end
      # verify the required parameter 'slug' is set
      if @api_client.config.client_side_validation && slug.nil?
        fail ArgumentError, "Missing the required parameter 'slug' when calling FlowsApi.flows_instances_set_background_url_create"
      end
      # verify the required parameter 'file_path_request' is set
      if @api_client.config.client_side_validation && file_path_request.nil?
        fail ArgumentError, "Missing the required parameter 'file_path_request' when calling FlowsApi.flows_instances_set_background_url_create"
      end
      # resource path
      local_var_path = '/flows/instances/{slug}/set_background_url/'.sub('{' + 'slug' + '}', CGI.escape(slug.to_s))
      ...
      new_options = opts.merge(
        :operation => :"FlowsApi.flows_instances_set_background_url_create",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: FlowsApi#flows_instances_set_background_url_create\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
