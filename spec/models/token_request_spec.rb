...
# Unit tests for Authentik::Api::TokenRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Authentik::Api::TokenRequest do
  #let(:instance) { Authentik::Api::TokenRequest.new }

  describe 'test an instance of TokenRequest' do
    it 'should create an instance of TokenRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Authentik::Api::TokenRequest)
    end
  end
