...
# Unit tests for Authentik::Api::Connector
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Authentik::Api::Connector do
  #let(:instance) { Authentik::Api::Connector.new }

  describe 'test an instance of Connector' do
    it 'should create an instance of Connector' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Authentik::Api::Connector)
    end
  end
