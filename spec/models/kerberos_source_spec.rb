...
# Unit tests for Authentik::Api::KerberosSource
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Authentik::Api::KerberosSource do
  #let(:instance) { Authentik::Api::KerberosSource.new }

  describe 'test an instance of KerberosSource' do
    it 'should create an instance of KerberosSource' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Authentik::Api::KerberosSource)
    end
  end
