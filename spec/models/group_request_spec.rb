...
# Unit tests for Authentik::Api::GroupRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Authentik::Api::GroupRequest do
  #let(:instance) { Authentik::Api::GroupRequest.new }

  describe 'test an instance of GroupRequest' do
    it 'should create an instance of GroupRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Authentik::Api::GroupRequest)
    end
  end
