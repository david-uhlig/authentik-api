...
# Unit tests for Authentik::Api::Token
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Authentik::Api::Token do
  #let(:instance) { Authentik::Api::Token.new }

  describe 'test an instance of Token' do
    it 'should create an instance of Token' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Authentik::Api::Token)
    end
  end
