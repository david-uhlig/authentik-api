...
# Unit tests for Authentik::Api::UserRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Authentik::Api::UserRequest do
  #let(:instance) { Authentik::Api::UserRequest.new }

  describe 'test an instance of UserRequest' do
    it 'should create an instance of UserRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Authentik::Api::UserRequest)
    end
  end
