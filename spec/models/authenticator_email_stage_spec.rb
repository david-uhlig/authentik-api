...
# Unit tests for Authentik::Api::AuthenticatorEmailStage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Authentik::Api::AuthenticatorEmailStage do
  #let(:instance) { Authentik::Api::AuthenticatorEmailStage.new }

  describe 'test an instance of AuthenticatorEmailStage' do
    it 'should create an instance of AuthenticatorEmailStage' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Authentik::Api::AuthenticatorEmailStage)
    end
  end
