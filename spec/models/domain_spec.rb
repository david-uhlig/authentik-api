...
# Unit tests for Authentik::Api::Domain
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Authentik::Api::Domain do
  #let(:instance) { Authentik::Api::Domain.new }

  describe 'test an instance of Domain' do
    it 'should create an instance of Domain' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Authentik::Api::Domain)
    end
  end
