...
# Unit tests for Authentik::Api::AuthenticatorTOTPStage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Authentik::Api::AuthenticatorTOTPStage do
  #let(:instance) { Authentik::Api::AuthenticatorTOTPStage.new }

  describe 'test an instance of AuthenticatorTOTPStage' do
    it 'should create an instance of AuthenticatorTOTPStage' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Authentik::Api::AuthenticatorTOTPStage)
    end
  end
