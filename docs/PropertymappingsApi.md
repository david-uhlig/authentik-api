...
api_instance = Authentik::Api::PropertymappingsApi.new
telegram_source_property_mapping_request = Authentik::Api::TelegramSourcePropertyMappingRequest.new({name: 'name_example', expression: 'expression_example'}) # TelegramSourcePropertyMappingRequest | 

begin
  
  result = api_instance.propertymappings_source_telegram_create(telegram_source_property_mapping_request)
  p result
rescue Authentik::Api::ApiError => e
  puts "Error when calling PropertymappingsApi->propertymappings_source_telegram_create: #{e}"
end
```

#### Using the propertymappings_source_telegram_create_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<TelegramSourcePropertyMapping>, Integer, Hash)> propertymappings_source_telegram_create_with_http_info(telegram_source_property_mapping_request)

```ruby
begin
  
  data, status_code, headers = api_instance.propertymappings_source_telegram_create_with_http_info(telegram_source_property_mapping_request)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <TelegramSourcePropertyMapping>
rescue Authentik::Api::ApiError => e
  puts "Error when calling PropertymappingsApi->propertymappings_source_telegram_create_with_http_info: #{e}"
end
```
...
api_instance = Authentik::Api::PropertymappingsApi.new
pm_uuid = '38400000-8cf0-11bd-b23e-10b96e4ef00d' # String | A UUID string identifying this Telegram Source Property Mapping.

begin
  
  api_instance.propertymappings_source_telegram_destroy(pm_uuid)
rescue Authentik::Api::ApiError => e
  puts "Error when calling PropertymappingsApi->propertymappings_source_telegram_destroy: #{e}"
end
```

#### Using the propertymappings_source_telegram_destroy_with_http_info variant

This returns an Array which contains the response data (`nil` in this case), status code and headers.

> <Array(nil, Integer, Hash)> propertymappings_source_telegram_destroy_with_http_info(pm_uuid)

```ruby
begin
  
  data, status_code, headers = api_instance.propertymappings_source_telegram_destroy_with_http_info(pm_uuid)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => nil
rescue Authentik::Api::ApiError => e
  puts "Error when calling PropertymappingsApi->propertymappings_source_telegram_destroy_with_http_info: #{e}"
end
```
...
> <PaginatedTelegramSourcePropertyMappingList> propertymappings_source_telegram_list(opts)
...
begin
  ...
  result = api_instance.propertymappings_source_telegram_list(opts)
  p result
rescue Authentik::Api::ApiError => e
  puts "Error when calling PropertymappingsApi->propertymappings_source_telegram_list: #{e}"
end
```

#### Using the propertymappings_source_telegram_list_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<PaginatedTelegramSourcePropertyMappingList>, Integer, Hash)> propertymappings_source_telegram_list_with_http_info(opts)

```ruby
begin
  
  data, status_code, headers = api_instance.propertymappings_source_telegram_list_with_http_info(opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <PaginatedTelegramSourcePropertyMappingList>
rescue Authentik::Api::ApiError => e
  puts "Error when calling PropertymappingsApi->propertymappings_source_telegram_list_with_http_info: #{e}"
end
```
...
> <TelegramSourcePropertyMapping> propertymappings_source_telegram_partial_update(pm_uuid, opts)
...
pm_uuid = '38400000-8cf0-11bd-b23e-10b96e4ef00d' # String | A UUID string identifying this Telegram Source Property Mapping.
opts = {
  patched_telegram_source_property_mapping_request: Authentik::Api::PatchedTelegramSourcePropertyMappingRequest.new # PatchedTelegramSourcePropertyMappingRequest | 
}

begin
  
  result = api_instance.propertymappings_source_telegram_partial_update(pm_uuid, opts)
  p result
rescue Authentik::Api::ApiError => e
  puts "Error when calling PropertymappingsApi->propertymappings_source_telegram_partial_update: #{e}"
end
```

#### Using the propertymappings_source_telegram_partial_update_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<TelegramSourcePropertyMapping>, Integer, Hash)> propertymappings_source_telegram_partial_update_with_http_info(pm_uuid, opts)

```ruby
begin
  
  data, status_code, headers = api_instance.propertymappings_source_telegram_partial_update_with_http_info(pm_uuid, opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <TelegramSourcePropertyMapping>
rescue Authentik::Api::ApiError => e
  puts "Error when calling PropertymappingsApi->propertymappings_source_telegram_partial_update_with_http_info: #{e}"
end
```
...
begin
  ...
  result = api_instance.propertymappings_source_telegram_retrieve(pm_uuid)
  p result
rescue Authentik::Api::ApiError => e
  puts "Error when calling PropertymappingsApi->propertymappings_source_telegram_retrieve: #{e}"
end
```

#### Using the propertymappings_source_telegram_retrieve_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<TelegramSourcePropertyMapping>, Integer, Hash)> propertymappings_source_telegram_retrieve_with_http_info(pm_uuid)

```ruby
begin
  
  data, status_code, headers = api_instance.propertymappings_source_telegram_retrieve_with_http_info(pm_uuid)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <TelegramSourcePropertyMapping>
rescue Authentik::Api::ApiError => e
  puts "Error when calling PropertymappingsApi->propertymappings_source_telegram_retrieve_with_http_info: #{e}"
end
```
...
begin
  ...
  result = api_instance.propertymappings_source_telegram_update(pm_uuid, telegram_source_property_mapping_request)
  p result
rescue Authentik::Api::ApiError => e
  puts "Error when calling PropertymappingsApi->propertymappings_source_telegram_update: #{e}"
end
```

#### Using the propertymappings_source_telegram_update_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<TelegramSourcePropertyMapping>, Integer, Hash)> propertymappings_source_telegram_update_with_http_info(pm_uuid, telegram_source_property_mapping_request)

```ruby
begin
  
  data, status_code, headers = api_instance.propertymappings_source_telegram_update_with_http_info(pm_uuid, telegram_source_property_mapping_request)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <TelegramSourcePropertyMapping>
rescue Authentik::Api::ApiError => e
  puts "Error when calling PropertymappingsApi->propertymappings_source_telegram_update_with_http_info: #{e}"
end
```
...
> <Array<UsedBy>> propertymappings_source_telegram_used_by_list(pm_uuid)
...
begin
  ...
  result = api_instance.propertymappings_source_telegram_used_by_list(pm_uuid)
  p result
rescue Authentik::Api::ApiError => e
  puts "Error when calling PropertymappingsApi->propertymappings_source_telegram_used_by_list: #{e}"
end
```

#### Using the propertymappings_source_telegram_used_by_list_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<Array<UsedBy>>, Integer, Hash)> propertymappings_source_telegram_used_by_list_with_http_info(pm_uuid)

```ruby
begin
  
  data, status_code, headers = api_instance.propertymappings_source_telegram_used_by_list_with_http_info(pm_uuid)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <Array<UsedBy>>
rescue Authentik::Api::ApiError => e
  puts "Error when calling PropertymappingsApi->propertymappings_source_telegram_used_by_list_with_http_info: #{e}"
end
```
