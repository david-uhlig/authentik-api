# Authentik::Api::PatchedGeoIPPolicyRequest
...
| **countries** | [**Array&lt;CountryCodeEnum&gt;**](CountryCodeEnum.md) |  | [optional] |
...
instance = Authentik::Api::PatchedGeoIPPolicyRequest.new(
  name: null,
